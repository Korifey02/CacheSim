...
class Sim {
 ...
 private:
	 ...
	 // ������ ������ - ����� ������ �� ���������������(������ �����������) (��������, 0 - 63)
 // ������ ������ - ������ � ������(�������� 0 - 7 ��� 8 - way),
	 std::uint64_t** cacheTable = nullptr;
	 std::uint64_t** validTable = nullptr;
	 std::uint64_t* validTableValues = nullptr; // ������ ���������� ������� �����
	 std::uint64_t** dirtyTable = nullptr;		  // ���� "dirty" - ��������� �� � ������� / ������� ������� ����
									      // ��� ��������� ������������ ���� ������ ��� �� �����
	 std::uint64_t** timeTable = nullptr;
#ifdef MAP_SIM
	 std::map<std::string, int64_t> arrays; // ������ - ����� ��������
	 std::map<std::string, int64_t> arrays_write; // ������ - ����� �������� �� ������ 
#else
	 std::int32_t arrays_num = 0;
	 struct array_type_sim arrays[NUM_LOCAL_ARRAYS];	// ������ - ����� ��������
	 std::int64_t arrays_write[NUM_LOCAL_ARRAYS]; // ������ - ����� �������� �� ������ 
#endif
	 std::ofstream trace;
	 void init_cache();
